...
import { renderToString } from 'file://D:/Xia/my/test/enterprise-website/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://D:/Xia/my/test/enterprise-website/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file://D:/Xia/my/test/enterprise-website/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://D:/Xia/my/test/enterprise-website/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://D:/Xia/my/test/enterprise-website/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://D:/Xia/my/test/enterprise-website/node_modules/devalue/index.js';
import { isVNode, isRef, toValue } from 'file://D:/Xia/my/test/enterprise-website/node_modules/vue/index.mjs';
import { createHooks } from 'file://D:/Xia/my/test/enterprise-website/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://D:/Xia/my/test/enterprise-website/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://D:/Xia/my/test/enterprise-website/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/Xia/my/test/enterprise-website/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/Xia/my/test/enterprise-website/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://D:/Xia/my/test/enterprise-website/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/Xia/my/test/enterprise-website/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://D:/Xia/my/test/enterprise-website/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://D:/Xia/my/test/enterprise-website/node_modules/youch-core/build/index.js';
import { Youch } from 'file://D:/Xia/my/test/enterprise-website/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://D:/Xia/my/test/enterprise-website/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://D:/Xia/my/test/enterprise-website/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/Xia/my/test/enterprise-website/node_modules/errx/dist/index.js';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://D:/Xia/my/test/enterprise-website/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://D:/Xia/my/test/enterprise-website/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"D:/Xia/my/test/enterprise-website/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/Xia/my/test/enterprise-website","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/Xia/my/test/enterprise-website/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/Xia/my/test/enterprise-website/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/Xia/my/test/enterprise-website/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:/Xia/my/test/enterprise-website/.data/kv"}));
...
const _GobA4aIgTf2t4D_GzBSDu6BImhLV9HsxPan2XSEfYi0 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/Xia/my/test/enterprise-website";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"我们为客户提供优质厂家商品，欢迎联系我们了解更多信息"},{"name":"keywords","content":"企业官网,厂家商品,优质产品,联系我们"}],"link":[],"style":[],"script":[],"noscript":[],"title":"企业官网 - 提供优质厂家商品"};
...
const _XUCxeqsIjf0pMLoIFSr5xjW9ed2aGLmZpe02Azj3ibI = (nitroApp) => {
...
const plugins = [
  _GobA4aIgTf2t4D_GzBSDu6BImhLV9HsxPan2XSEfYi0,
...
const _LV6PxK = eventHandler((event) => {
...
const getServerEntry = () => import('file://D:/Xia/my/test/enterprise-website/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file://D:/Xia/my/test/enterprise-website/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const _U1dbFuMeta = null;

const _OzA_jIMeta = null;

const _vKNGDjMeta = null;

const _aXIvLUMeta = null;
...
const _3epR2QMeta = null;

const _wMrh9TMeta = null;

const _DS0ZClMeta = null;

const _9GI4E3Meta = null;

const _SxA8c9Meta = null;

const _Ow1sRyMeta = null;

const _3fJ8fvMeta = null;

const _zo16b2Meta = null;

const handlersMeta = [
  { route: "/api/contacts/:id", method: "delete", meta: _U1dbFuMeta },
{ route: "/api/contacts/:id", method: "get", meta: _OzA_jIMeta },
...
{ route: "/api/products", method: "get", meta: _wMrh9TMeta },
{ route: "/api/products", method: "post", meta: _DS0ZClMeta },
{ route: "/__nuxt_error", method: undefined, meta: _9GI4E3Meta },
{ route: "/__nuxt_island/**", method: undefined, meta: _SxA8c9Meta },
{ route: "/_openapi.json", method: undefined, meta: _Ow1sRyMeta },
{ route: "/_scalar", method: undefined, meta: _3fJ8fvMeta },
{ route: "/_swagger", method: undefined, meta: _zo16b2Meta }
  ];

const _Ow1sRy = eventHandler((event) => {
...
const _3fJ8fv = eventHandler((event) => {
  const runtimeConfig = useRuntimeConfig(event);
...
const _zo16b2 = eventHandler((event) => {
  const runtimeConfig = useRuntimeConfig(event);
  const title = runtimeConfig.nitro.openAPI?.meta?.title || "API Reference";
  const description = runtimeConfig.nitro.openAPI?.meta?.description || "";
  const openAPIEndpoint = runtimeConfig.nitro.openAPI?.route || "./_openapi.json";
...
const _lazy_wMrh9T = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_DS0ZCl = () => Promise.resolve().then(function () { return index_post$1; });
const _lazy_9GI4E3 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _LV6PxK, lazy: false, middleware: true, method: undefined },
  { route: '/api/contacts/:id', handler: _lazy_U1dbFu, lazy: true, middleware: false, method: "delete" },
  { route: '/api/contacts/:id', handler: _lazy_OzA_jI, lazy: true, middleware: false, method: "get" },
  ...
  { route: '/api/products', handler: _lazy_wMrh9T, lazy: true, middleware: false, method: "get" },
  { route: '/api/products', handler: _lazy_DS0ZCl, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_9GI4E3, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_openapi.json', handler: _Ow1sRy, lazy: false, middleware: false, method: undefined },
  { route: '/_scalar', handler: _3fJ8fv, lazy: false, middleware: false, method: undefined },
  { route: '/_swagger', handler: _zo16b2, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_9GI4E3, lazy: true, middleware: false, method: undefined }
];
